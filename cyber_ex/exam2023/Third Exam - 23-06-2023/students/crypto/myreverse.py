...
def base32decode(message):
    b32_message = message.encode('ascii')
    b32_bytes = base64.b32decode(b32_message)
    message_bytes = b32_bytes.decode('ascii')
...
# DO YOUR STUFF
first = XORencode(message=encrypted_flag)
second = base32decode(first)
print(second)
